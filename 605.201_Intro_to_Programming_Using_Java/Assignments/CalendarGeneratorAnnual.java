/**
    * This application generates annual calendars and outputs to the screen.
    * The user specifies the year and the program generates 12 corresponding     
...
public class CalendarGeneratorAnnual
{
    ...
    public static void main (String [] args)
    {
        ...
        printAllCalendars(year); //print specified calendar
