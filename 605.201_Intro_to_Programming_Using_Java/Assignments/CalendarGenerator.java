...
public class CalendarGenerator
{
    ...
    public static void main (String [] args)
    {
        ...
        //Get calendar month. Must be between 1 and 12
        month = getInteger("\nPlease enter a calendar month (1-12)", input, 1, 12);
        ...
        year = getInteger("Please enter a calendar year (4 digits, e.g. 2017)", input, 0, 9999);
